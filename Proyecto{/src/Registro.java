...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro comprador");
...
dispose();        // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            cli.setNombres(nom.getText());
            cli.setApellidos(apll.getText());
            cli.setCedula(ced.getText().length());
            cli.setEmail(mail.getText());
            cli.setCiudad(ciud.getSelectedItem().toString());
            cli.setDireccion(direc.getText());
            cli.setCelular(cell.getText());
            cli.setEdad(edad.getValue().hashCode());
            cli.setCodPostal(post.getText());
